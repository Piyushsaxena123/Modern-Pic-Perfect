  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-6 min-h-[500px]">
        {/* Sidebar Filters */}
        <div className="w-48 shrink-0 glass rounded-xl p-4 space-y-2 h-fit">
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center glass rounded-xl">
